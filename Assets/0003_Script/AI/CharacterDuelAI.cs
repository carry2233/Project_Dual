...
private void TryResolveDuel() // 결투 판정 처리
{
    ...
    int selfRolledSpeedRatePercent = globalGameRuleManager.RollBattleSpeedRatePercent(characterStatSystem); // 자신의 랜덤 속도율 결정
    int otherRolledSpeedRatePercent = globalGameRuleManager.RollBattleSpeedRatePercent(otherStat); // 상대의 랜덤 속도율 결정
